package com.aluracursos.desafio_literalura.LiteraluraChallenge.principal;

import com.aluracursos.desafio_literalura.LiteraluraChallenge.models.Datos;
import com.aluracursos.desafio_literalura.LiteraluraChallenge.models.DatosLibros;
import com.aluracursos.desafio_literalura.LiteraluraChallenge.models.DatosAutores;
...
import com.aluracursos.desafio_literalura.LiteraluraChallenge.service.ConsumoApi;
import com.aluracursos.desafio_literalura.LiteraluraChallenge.service.ConvierteDatos;
...
public class Principal {
    ...
    private IAutoresRepositorio autoresRepositorio;
    private ILibrosRepositorio librosRepositorio;

    public Principal(IAutoresRepositorio autoresRepository, ILibrosRepositorio librosRepository) {
    ...
    private  void agregarLibros() {
        ...
        if (!datos.resultados().isEmpty()) {
            ...
            if (libroRepositorio != null) {
                ...
                Autores autorRepositorio = autoresRepositorio.findByNameIgnoreCase(datosLibro.autor().get(0).nombreAutor());
            ...
            System.out.println("El libro no existe en la API de Gutendex, ingrese otro por favor");
        }
    }
    ...
    private void autoresPorAño() {
        ...
        List<Autores> autoresPorAño = autoresRepositorio.findByAñoNacimientoLessThanEqualAndAñoMuerteGreaterThanEqual(año, año);
